...
| `https://github.com/<owner>/<repo>/discussions/<n>`                        | GitHub Discussion body    |
| `https://github.com/<owner>/<repo>/discussions/<n>#discussioncomment-<id>` | GitHub Discussion comment |
